//BASE DE DATOS
	var productos = ["Antivirus", "USB 32Gb", "Disco duro", "PC Escritorio", "CCTV", "Laptop", "Memoria RAM", "Router", "Tablet Android"];
	var imgGrandes = ["productos/nod.jpg", "img/productos/2.jpg", "productos/hdd.jpg", "img/productos/4.jpg", "img/productos/5.jpg", "img/productos/6.jpg", "img/productos/7.jpg", "img/productos/8.jpg", "img/productos/9.jpg"];
	var imgPeque = ["productos/nod.jpg", "productos/usb.jpg", "productos/hdd.jpg", "productos/pc.jpg", "productos/cctv.jpg", "productos/laptop.jpg", "productos/ram.jpg", "productos/router.jpeg", "productos/tablet.jpg"];
	var precios = [250.00, 240.00, 450.00, 4500.00, 8550.00, 5500.00, 350.00, 870.00, 450.00];
...
/**/			document.getElementById("divPago").className = "divsNo";
		...
		//Se a�ade a la tabla el TOTAL que suma el carrito:
